...
from channel.views import UserChannelView, ChannelView, ContentView, HomeContentView, RelatedContentsView, CategoriesView, VideoUploadView, FileUploadView
from rest_framework_extensions.routers import ExtendedDefaultRouter

router = ExtendedDefaultRouter()

router.register('user-channels', UserChannelView, 'user-based-channels').register('videoFileUpload', VideoUploadView, basename = 'file-upload', parents_query_lookups=['channel_slug'])
